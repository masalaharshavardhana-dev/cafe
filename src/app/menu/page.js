...
const menuData = [
  {
    ...
    items: [
      ...
      { name: 'Cà phê Latte', price: '230', img: 'https://images.unsplash.com/photo-1541167760496-1628856ab772?auto=format&fit=crop&w=800&q=60' },
      { name: 'Cà phê Mocha', price: '250', img: 'https://images.unsplash.com/photo-1607681034540-2c46cc71896d?auto=format&fit=crop&w=800&q=60' },
